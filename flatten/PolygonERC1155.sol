...
// Dependency file: @openzeppelin/contracts/token/ERC1155/extensions/ERC1155URIStorage.sol
...
// Root file: contracts/PolygonERC1155.sol
...
contract PolygonERC1155 is ERC1155URIStorage {
    ...
    constructor() public ERC1155("") {
        _mint(msg.sender, GOLD, 10**18, "ipfs://bafkreicyklmz3bv2myrr4r6zmicz2ucx7luykdrto75xrbwfyxuknkliqy");
        _mint(msg.sender, SILVER, 10**27, "ipfs://bafkreifgnp4xg227cdlcegvxwqcyd67fyu3hcrf2v6i36grj7ap35nezlq");
        _mint(msg.sender, BRONZE, 10**30, "ipfs://bafkreiagl24zffodowo4xnic6bqrpeqrkp3vwpdrnljnysvmskw235k6fi");
        _mint(msg.sender, DIAMOND, 1, "ipfs://bafkreiejeohyy23tfhebck7vqxbwyqk7lmeaklgnuqfl64mz6kocyne3oi");
    }
